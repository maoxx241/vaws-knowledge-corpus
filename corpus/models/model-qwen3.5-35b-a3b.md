# Historical, unverified: Qwen3.5-35B-A3B: 40-layer hybrid linear/full-attention MoE model; verified TP2 on A3
...
Migrated from the [versioned workspace note](https://github.com/vllm-ascend-workspace/vllm-ascend-workspace/blob/f85b57165600d7da98c760304dc854cdf611f25f/.agents/knowledge/model-qwen3.5-35b-a3b.md). Historical implementation paths and verification wording above describe that source, not the current VAWS or vLLM-Ascend release.
