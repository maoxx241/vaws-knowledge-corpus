...
Migrated from the [versioned workspace note](https://github.com/vllm-ascend-workspace/vllm-ascend-workspace/blob/f85b57165600d7da98c760304dc854cdf611f25f/.agents/knowledge/graph-capture-device-to-host-probe-changes-measured-behavior.md). Historical implementation paths and verification wording above describe that source, not the current VAWS or vLLM-Ascend release.
